...
/// @title GLYPHRootUpdaterMinimal
/// @notice Optional L2 root updater that binds GLYPH proofs to state root updates.
/// @dev Calls GLYPHVerifier via packed calldata. Stores only state_root and batch_id.
contract GLYPHRootUpdaterMinimal {
    ...
    function verifyRootUpdate(
        ...
        emit RootUpdated(old_root, new_root, da_commitment, current_batch, bytes32(0));
    }
