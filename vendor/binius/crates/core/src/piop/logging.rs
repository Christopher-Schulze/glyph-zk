...
#[derive(Serialize)]
pub(crate) struct SumcheckBatchProverDimensionsData {
...
#[derive(Serialize)]
pub(crate) struct FriFoldRoundsData {
	round: usize,
...
impl FriFoldRoundsData {
	pub(crate) fn new(round: usize, log_batch_size: usize, codeword_len: usize) -> Self {
		Self {
			round,
			log_batch_size,
			codeword_len,
