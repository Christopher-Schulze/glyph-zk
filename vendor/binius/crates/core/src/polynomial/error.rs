...
pub enum Error {
	...
	#[error("challenge values for this field are not set")]
	ChallengeValuesMissing,
	#[error("challenge index {index} is out of range (len={len})")]
	ChallengeIndexOutOfRange { index: usize, len: usize },
}
